...
int main(int argc, char* argv[]) {
    ...
    std::vector<unsigned int> body_id = {2, 4};
    std::vector<RBDL::Math::Vector3d> body_point = {RBDL::Math::Vector3d(0., 0.8, 0), RBDL::Math::Vector3d(0., 0.8, 0)};
    std::vector<RBDL::Math::Vector3d> target_pos = {RBDL::Math::Vector3d(0., 0, 0), RBDL::Math::Vector3d(0., 0, 0)};
